...
import { inspectCodexAppServerProcess, readProcessStartTime } from "./processes";
...
type TrackedProcessLiveness = "alive" | "dead" | "unknown";

function inspectTrackedProcessLiveness(tracked: TrackedPid): TrackedProcessLiveness {
  try {
